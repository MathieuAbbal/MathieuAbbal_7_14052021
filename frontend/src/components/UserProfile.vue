  ...
  <!-- message d'acceuil profil --> 
    ...
    <form class="mt-8 space-y-3">
      <div class="flex flex-col ">
        ...
        <textarea id="bio" class="m-8 p-2 p lg:h-36 text-base border border-gray-300 rounded-lg focus:outline-none focus:border-gray-900" type="" placeholder="Votre description"></textarea>
      </div>
